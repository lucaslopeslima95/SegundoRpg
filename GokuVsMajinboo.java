...
public class GokuVsMajinboo extends JFrame {
	...
	public GokuVsMajinboo() {
		...
		lblper2.setIcon(new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\majinboo1.gif"));
		...
		lblCenarioLuta.setIcon(new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\cenarioMajinboo.jpg"));
	...
	public void chuteCpu() {
		...
		TimerTask tarefa1 = new TimerTask() {
			...
			public void run() {
				lblper2.setIcon(
						new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\MajinbookChute.png"));
				lblGoku.setIcon(
	...
	public void especialPlayer() {
		...
		lblper2.setIcon(new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\MajinbooDamege.png"));
		contEspecial--;
	...
	public void socoCpu() {
		TimerTask tarefa1 = new TimerTask() {
			...
			public void run() {
				lblper2.setIcon(
						new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\mjinbooSoco.png"));
				lblGoku.setIcon(
						new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\gokudamage.png"));
				labelHpPlayer.setForeground(Color.RED);
				lblper2.setBounds(170, 104, 145, 134);
		...
		TimerTask tarefa1 = new TimerTask() {
			...
			public void run() {
				if (move <= 300) {
					...
					move = 310;
					lblper2.setIcon(
							new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\MajinbooDamege.png"));
				} else if (move == 310) {
		...
		TimerTask tarefa3 = new TimerTask() {
			...
			public void run() {
				if (move == 320) {
					...
					lblper2.setIcon(
							new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\majinboo1.gif"));
	...
	public void testaVidaCpu(int hp) {
		if (hp <= 0) {
			flag = false;
			lblper2.setIcon(new ImageIcon("C:\\Users\\lopes\\Desktop\\Entra21\\SuperRpg\\src\\res\\MajinbooDie.png"));
